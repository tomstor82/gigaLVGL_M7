 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --bpp 4 --size 20 --no-compress --font FontAwesome5-Solid+Brands+Regular.woff --range 61829,61926,61671,62943 --format lvgl -o FontAwesomeSolid20_icons.c
 ******************************************************************************/
...
#ifndef FONTAWESOMESOLID20_ICONS
#define FONTAWESOMESOLID20_ICONS 1
#endif

#if FONTAWESOMESOLID20_ICONS
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 200, .box_w = 14, .box_h = 21, .ofs_x = -1, .ofs_y = -3},
    {.bitmap_index = 147, .adv_w = 320, .box_w = 20, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 357, .adv_w = 240, .box_w = 15, .box_h = 21, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 515, .adv_w = 320, .box_w = 20, .box_h = 15, .ofs_x = 0, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t FontAwesomeSolid20_icons = {
#else
lv_font_t FontAwesomeSolid20_icons = {
#endif
...
#endif /*#if FONTAWESOMESOLID20_ICONS*/
